...
const Regiment = ({ regimens }) => {
    ...
    console.log(regimens)
    return (
        <div className='day-regimen container'>
            {/* <p> My Tasks </p> */}
            <div className="row">

                <div className="day col-4" id="sunday">
                    <h2>Sunday</h2>
                    {regimens.map(goal => {
                        if (goal.day === "Sunday") {
                ...
                <div className="day col-4" id="monday">
                    <h2>Monday</h2>
                    {regimens.map(goal => {
                        if (goal.day === "Monday") {
                ...
                <div className="day col-4" id="tuesday">
                    <h2>Tuesday</h2>
                    {regimens.map(goal => {
                        if (goal.day === "Tuesday") {
            ...
            <div className="row">
                ...
                <div className="day col-4" id="wednesday">
                    <h2>Wednesday</h2>
                    {regimens.map(goal => {
                ...
                <div className="day col-4" id="thursday">
                    <h2>Thursday</h2>
                    {regimens.map(goal => {
                ...
                <div className="day col-4" id="friday">
                    <h2>Friday</h2>
                    {regimens.map(goal => {
                        if (goal.day === "Friday") {
